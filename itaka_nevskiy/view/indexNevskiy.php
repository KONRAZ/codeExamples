...
<div class="box-1" id="box-1" style="background-image: url(../img/nevskiy/nevskiy_region/box-1-bg.png)">
    <div class="container">
          ...
          <div class="row">
            <div class="col-lg-12">
              <h1 class="subtitle center-block">
                <span>
                  <a href="tel:+79210952645">8 (921) 095-26-45</a>
                </span>
              </h1>
            </div>
          </div>
    ...
    <div class="container">
        ...
        <div class="row mt-4">
            <div class="col-lg-4 col-12">
                <a href="/indexNevskiy/new" >
                    <div class="object">
                        <img src="/img/nevskiy/nevskiy_region/new.png" alt="">
                        <div class="head">
            ...
            <div class="col-lg-4 col-12">
                <a href="/indexNevskiy/home" >
                    <div class="object">
                        <img src="/img/nevskiy/nevskiy_region/second.png" alt="">
                        <div class="head">
            ...
            <div class="col-lg-4 col-12">
                <a href="/indexNevskiy/rent">
                    <div class="object">
                        <img src="/img/nevskiy/nevskiy_region/rent.png" alt="">
                        <div class="head">
            ...
            <div class="col-lg-4 col-12">
                <a href="#" data-dest=".box-4">
                    <div class="object">
                        <img src="/img/nevskiy/nevskiy_region/country.png" alt="">
                        <div class="head">
            ...
            <div class="col-lg-4 col-12">
                  <a href="#" data-dest=".box-4">
                    <div class="object">
                        <img src="/img/nevskiy/nevskiy_region/commerce.png" alt="">
                        <div class="head">
            ...
            <div class="col-lg-4 col-12">
                <a href="#" data-dest=".box-4">
                    <div class="object">
                        <img src="/img/nevskiy/nevskiy_region/pereustup.png" alt="">
                        <div class="head">
...
<div class="box-4" style="background-image: url(../img/nevskiy/nevskiy_region/box-4-bg.png)">
...
<div class="box-6" id="box-6">
  <div class="container">
    ...
    <div class="row pb-5">
        ...
        <div class="col-8 col-lg-10">
            <div class="row" id="agent-slider1">
              ...
              <?php
                ...
                $agentList = $agentLists['nevskiy'];
                foreach ($agentList as $item) :
                  ?>

                <div class="col-lg-3 text-center <?php if ($item['tag']!=''){echo $item['tag'];} ?>">
                    <div class="photo">
                        <img src="/img/nevskiy/sotrudniki/nevskiy_region/<?php echo $item['photo'] ?>.jpg">
                    </div>
                    <div class="special">
                      <?php switch ($item['tag']) :
                        case 'new' : ?>
        ...
        <div class="col-2 col-lg-1">
            <div class="arrow left" id="agent-next-arrow1">
